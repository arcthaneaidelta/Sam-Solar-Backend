...
- If you don't have the customer's name and address, immediately use the query-customer-data tool with phone number: ${callerPhone}
- Once you have customer data, always use their actual name "${customerData?.name || '[NAME]'}" when addressing them
- Reference their specific address "${customerData?.address || '[ADDRESS]'}" when discussing the program
- The customer information should be used naturally in conversation
