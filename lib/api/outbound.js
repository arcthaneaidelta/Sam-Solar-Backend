...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    const callParams = {
      user_id: parseInt(to.replace(/^\+/, "").replace(/\D/g, "")), // Convert to integer, remove + and non-digits
      application_id: parseInt(VOXIMPLANT_CONFIG.applicationId), // Also convert application_id to integer
